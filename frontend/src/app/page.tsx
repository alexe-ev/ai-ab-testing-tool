...
import { getExperiments, getSettings, getTestSets, getRubrics } from "@/lib/api";
import type { ExperimentListItem, SummaryMetrics, SettingItem, TestSetListItem, RubricListItem } from "@/lib/types";
...
export default function ExperimentsPage() {
  ...
  const hasApiKeys = settings.some((s) => s.is_set);
        ...
        <>
          ...
          {experiments.length === 0 ? (
            <EmptyState
              ...
              description="Experiments compare two prompt variants side by side using LLM-as-judge evaluation. Create your first experiment to start testing."
